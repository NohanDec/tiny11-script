...
if [ $link1_status = "200" ] ; then 
	sudo wget -O https://archive.org/download/tiny-11-NTDEV/tiny11%20b2%28no%20sysreq%29.iso 
elif [ $link2_status = "200" -o $link2_status = "301" -o $link2_status = "302" ] ; then 
	sudo wget -P https://archive.org/download/tiny-11-NTDEV/tiny11%20b2%28no%20sysreq%29.iso
else
